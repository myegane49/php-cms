  ...
  <tbody>
    <?php
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='comments.php?source=post_comments&post_id=$postId&approve=$commentId'>Approve</a></td>";
        echo "<td><a href='comments.php?source=post_comments&post_id=$postId&unapprove=$commentId'>Unapprove</a></td>";
        echo "<td><a href='comments.php?source=post_comments&post_id=$postId&delete=$commentId'>Delete</a></td>";
        echo "</tr>";
      }
    ?>
  </tbody>
...
if (isset($_GET['approve'])) {
  ...
  header("location: comments.php?source=post_comments&post_id=$postId");
}
